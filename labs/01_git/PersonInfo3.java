public class PersonInfo3 {
    ...
    public static String firstName = "Lamya";
    public static String lastName = "Abaline";
    public static int studentNo = 300038880;
    public static String description = "Likes to sleep";
